...
public class Play_Music_with_String_Simulation_and_String_utils {
    public String solution(String m, String[] musicinfos) {
        ...
        for(String musicinfo : musicinfos){
            ...
            String end = info[1];
            String title = info[2];
            String code = convertString(info[3]);
            ...
            if(sb.toString().contains(m) && (playTime > time)) {
                answer = title;
                time = playTime;
            }
        }
...
//         /*
//         * 비교방식이 잘못됨 : charAt .. C#과 같은 특수문자에 대한 판별이 불가능하다.
//         */
