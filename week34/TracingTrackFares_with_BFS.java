...
public class TracingTrackFares_with_BFS {
    static class Car{
    ...
    static int bfs(Car start, int size, int[][] board){
        ...
        while(!q.isEmpty()){
            ...
            for(int i = 0 ; i < 4 ; i++){
                ...
                //y방향 이동인데 방향 그대로
                if(nx == cur.x && ny != cur.y && cur.dir == 0){
                ...
                //y방향 이동인데 방향 전환
                else if(nx == cur.x && ny != cur.y && cur.dir == 1){
                    System.out.println("현재 : " + cur.x + ", " + cur.y);
                ...
                //x방향 이동인데 방향 그대로
                else if(ny == cur.y && nx != cur.x && cur.dir == 1){
                    System.out.println("현재 : " + cur.x + ", " + cur.y);
                ...
                //x방향 이동인데 방향 전환
                else if(ny == cur.y && nx != cur.x && cur.dir == 0){
                    System.out.println("현재 : " + cur.x + ", " + cur.y);
