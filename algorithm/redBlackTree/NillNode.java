...
public class NillNode {
    private Integer data = 0;
    private BinaryTree leftSubTree;
    private BinaryTree rightSubTree;
    private BinaryTree parentTree;
    private int height;
    private boolean color = Color.BLACK;

    public NillNode(Integer data) {
        this.data = data;
        this.leftSubTree = null;
        this.rightSubTree = null;
    }

    public NillNode(BinaryTree leftSubTree, BinaryTree rightSubTree, BinaryTree parentTree) {
